             ...
             children: [
               Column(
                 ...
                 children: [
                   ...
                   const Text(StringResources.registrationSuccess,
                     style: TextStyle(fontWeight: FontWeight.bold,fontSize: 35),),
                   const Text(StringResources.registrationSuccessMessage,
                     textAlign:TextAlign.center,style: TextStyle(fontSize: 20),),


                 ],
               ),
               DarkButton(radius: 20, text: const Text(
                   StringResources.continueMessage), actions: (){},
